          ...
          <div className="space-y-8">
            ...
            <div className="glass rounded-2xl p-6 glow-border animate-fade-in animation-delay-300">
              <p className="text-lg font-medium italic text-foreground">
                "My mission is to engineer reliable software systems that solve real-world problems gracefully. I believe in writing code that is as maintainable as it is efficient."
              </p>
            </div>
          </div>
