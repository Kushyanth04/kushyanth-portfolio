  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in animation-delay-300">
              ...
              <a href="/Kushyanth_Resume.pdf" target="_blank" rel="noopener noreferrer">
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                { icon: Github, href: "https://github.com/Kushyanth04" },
                { icon: Linkedin, href: "https://www.linkedin.com/in/bkushyanth/" },
              ].map((social, idx) => (
                <a
                  key={idx}
                  href={social.href}
          ...
          <div className="relatice animate-fade-in animation-delay-300">
            ...
            <div className="relative max-w-sm mx-auto flex justify-center">
              ...
              <div className="relative glass rounded-full p-2 glow-border">
                {/* 
                  Original Rectangular Profile Image
                  <img
      ...
      <div
        ...
        animate-fade-in animation-delay-800 transition-all duration-500 ${
